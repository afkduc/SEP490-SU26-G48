...
export default function ManagerExportRequestDetailPage() {
  ...
  if (loading) return <div className="mer-detail__loading">Dang tai...</div>;
  if (error) return <div className="mer-detail__error">Loi: {error}</div>;
  if (!data) return null;
    ...
    <div className="mer-detail">
      ...
      <div className="mer-detail__body">
        <div className="mer-detail__section">
          <h2 className="mer-detail__section-title">Thong tin chung</h2>
        ...
        <div className="mer-detail__section">
          ...
          {items.length === 0 ? (
            <p className="mer-detail__empty">Phieu khong co dong phu tung nao.</p>
          ) : (
