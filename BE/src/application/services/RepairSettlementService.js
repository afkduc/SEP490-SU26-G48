...
class RepairSettlementService {
  ...
  async createPayosPaymentLink(id, req = {}) {
    ...
    await auditCrud.lifecycle(req, {
      ...
      action: 'UPDATE',
      description: 'Phiếu quyết toán: tạo mã QR thanh toán PayOS',
  ...
  async handlePayosWebhook(rawBody, req = {}) {
    ...
    await auditCrud.lifecycle(req, {
      ...
      step: 'paid',
      stepLabel: 'Thanh toán QR PayOS / xuất hóa đơn',
      action: 'UPDATE',
      description: 'Phiếu quyết toán: xác nhận thanh toán qua QR PayOS — đã xuất hóa đơn',
