...
class RepairSettlementResponseDto {
  static fromEntity(entity) {
    ...
    return {
      ...
      assignmentDeclinedBy: entity.assignmentDeclinedBy ?? null,
      assignmentDeclinedByName: entity.assignmentDeclinedByName ?? null,
      assignmentDeclinedReason: entity.assignmentDeclinedReason ?? null,
      assignmentDeclinedAt: toDDMMYYYYHHmm(entity.assignmentDeclinedAt),
