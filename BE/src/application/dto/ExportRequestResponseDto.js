...
class ExportRequestResponseDto {
  ...
  static fromEntity(header, items = []) {
    ...
    return {
      ...
      issuerSignatureData: header.issuerSignatureData,
      issuerSignedAt: toDDMMYYYYHHmm(header.issuerSignedAt),
      issuerName: header.issuerName || header.performedByName || null,
